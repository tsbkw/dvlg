...
@Component({
  async asyncData({store, params}){
    return {
      post: await store.getters['posts/getById'](params.yyyymm, params.slug)
    }
  },
  async validates ({params}) {
    try {
      const markdownHtml = await store.getters['posts/getById'](params.yyyymm, params.slug)
...
.markdown-body >>> .hljs-tag .markdown-body >>> .hljs-attr {
  color: #008080;
}
...
.markdown-body >>> .hljs-class .markdown-body >>> .hljs-title {
  color: #458;
  font-weight: bold;
}
